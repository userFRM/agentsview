	...
	tests := []struct {
	...
	}{
		{
			...
			msgs: []db.Message{
				...
				{ToolResults: []db.ToolResult{
					{ToolUseID: "t1", ContentLength: 42, RawContent: `"[main abc1234] feat"`},
				}},
			},
		...
		},
		{
			...
			msgs: []db.Message{
				...
				{ToolResults: []db.ToolResult{
					{ToolUseID: "t1", ContentLength: 5000, RawContent: `"package main\n..."`},
				}},
			},
			blocked: map[string]bool{"Read": true, "Glob": true},
			want: []db.Message{
		...
		},
		{
			...
			msgs: []db.Message{
				...
				{ToolResults: []db.ToolResult{
					{ToolUseID: "t1", ContentLength: 100, RawContent: `"file content"`},
				}},
			},
			blocked: nil,
			want: []db.Message{
